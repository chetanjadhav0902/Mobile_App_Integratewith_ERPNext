...
const FloatingMenuScreen = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        >
          <Ionicons name="clipboard-outline" size={28} color="#03A9F4" />
        ...
        >
          <Ionicons name="briefcase-outline" size={28} color="#FF9800" />
          <Text style={styles.menuText}>Lead</Text>
        </TouchableOpacity>
        ...
        >
          ...
          <Text style={styles.menuText}>Site Survey</Text>
        </TouchableOpacity>
         ...
         <TouchableOpacity
          style={styles.menuItem}
          onPress={() => navigation.navigate('ExpenseClaim', { sid, employeeData, erpUrl })}
        >
          <Ionicons name="cash-outline" size={28} color="#4CAF50" />
          <Text style={styles.menuText}>Expense-Claim</Text>
        </TouchableOpacity>
...
export default FloatingMenuScreen;
